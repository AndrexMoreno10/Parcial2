...
public class ClsConexion {
    ...
    private String connectString = "jdbc:mysql://localhost:3306/Parcial2DS"; //ubicacion de la base de datos, para mysql esta es por defecto
    private String user = "root"; //usuario de la base de datos
    private String password = "MichellYAndresX100PRE"; //password de la base de datos
